...
public class ProductManager {
    ...
    private String createTableProduct =
            "CREATE TABLE Product(idProduct int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, idProvider int FOREIGN KEY REFERENCES Provider(idProvider) ON DELETE CASCADE , productName varchar(30), productDescription varchar(500), price double,)";
