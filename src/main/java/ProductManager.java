...
public class ProductManager {
    ...
    private String createTableProduct =
            "CREATE TABLE Product(idProduct int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, idProvider int DEFAULT NULL FOREIGN KEY REFERENCES Provider(idProvider) ON DELETE SET NULL, productName varchar(30), productDescription varchar(500), price double,)";
    ...
    public List<Provider> getAllProvidersByProducts(Product p){
        ...
        try {
            ...
            ResultSet rs = getAllProvidersByProductStmt.executeQuery();
